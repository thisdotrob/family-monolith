You are an expert software engineer. This is a complex but crucial step. Your task is to implement the automatic token refresh logic in the webapp. When a token has expired, this monolith's server responds with 401 and the following in the response body:
